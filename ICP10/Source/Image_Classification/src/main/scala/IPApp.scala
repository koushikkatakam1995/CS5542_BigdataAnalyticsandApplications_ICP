...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("chicken", "coke", "lemon", "onion", "cilantro", "biryani", "halal", "pizza", "paneer", "curd")
  ...
  def main(args: Array[String]) {
    System.setProperty("hadoop.home.dir","C:\\Users\\kiree\\Desktop\\winutils");
